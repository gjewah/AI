...
class FiqAiRegel(models.AbstractModel):
    ...
    ORDLISTE: ClassVar = [
        (
            "DEV",
            (
                "Testbenken. Bygges tom hver gang — data der forsvinner. "
        ...
        (
            "Staging",
            (
                "Kopi av Production å øve på. Data overlever her. "
        ...
        (
            "Production",
            (
                "Det ekte systemet, med ekte data. Ingenting skrives hit "
        ...
        (
            "Pinne",
            (
                "Et bokmerke som sier hvilken versjon av koden en server skal bruke. "
        ...
        (
            "Feilklasse",
            (
                "En type feil som gjentar seg i ulik forkledning. Vi navngir dem "
        ...
        (
            "Kunstpause",
            (
                "AI-en leverer én versjon og STOPPER — venter på din kommentar "
