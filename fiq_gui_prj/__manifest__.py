# -*- coding: utf-8 -*-
{
    "name": "FIQ GUI Prosjekt",
    "version": "19.0.1.0.0",
    "summary": "FIQ GUI-skjelett for flaten Prosjekt – OWL klient-handling "
 ...
 * OWL klient-handling «FIQ GUI Prosjekt» – enkel placeholder-side («Kommer»).
