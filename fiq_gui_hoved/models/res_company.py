...
class ResCompany(models.Model):
    ...
    # Per-firma branding for Hovedmeny. Generisk: alle firma deler samme
    # svartgrå sidemeny; kun aksentfargen + logo varierer.
    fiq_hoved_accent = fields.Char(
        string="Hovedmeny aksentfarge",
        default="#38B44A",
        help="Hex-farge brukt som aksent i Hovedmeny (aktiv meny, KPI, fremdrift).",
    )
    fiq_hoved_logo = fields.Binary(
    ...
    fiq_hoved_as_home = fields.Boolean(
